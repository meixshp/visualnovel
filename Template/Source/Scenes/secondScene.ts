namespace Template {
    export async function secondScene(): ƒS.SceneReturn {
        ...
        await ƒS.Character.show(characters.Amelie, characters.Amelie.pose.happy, ƒS.positionPercent(20, 100));
        await ƒS.update(1);
        await ƒS.Speech.tell(characters.Amelie, text.Helene.T0000);
